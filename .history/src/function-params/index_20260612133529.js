...
class FunctionParams {
  ...
  fillParams (paramsArr) {
    if (!this.paramsData || !paramsArr || paramsArr.length === 0) return

    // 格式化参数为字符串
    const paramsStr = paramsArr.map(item => {
